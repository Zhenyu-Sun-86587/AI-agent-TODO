...
- [前期项目计划书](doc/前期项目计划书.md)：面向产品展示的项目定位、功能规划、阶段计划、团队分工与风险应对。
- [功能草图](doc/功能草图.md)：系统功能总览、用户流程、页面结构、AI 创建流程与前后端交互草图。
- [作业 1 LaTeX 版](doc/作业1/assignment1_plan_sketch.tex)：项目计划书与功能草图的排版稿，使用 TikZ 统一重绘图形。
